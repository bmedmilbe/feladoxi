    ...
    <div className="bg-[#f6fafb]">
      <section className="border-b border-[#cfe3ea] bg-[#eaf7f9]">
        <div className="mx-auto max-w-[1280px] px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
          <p className="market-kicker">Apoio ao utilizador</p>
          <div className="mt-3 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-base leading-7 text-[#516f82]">
                Encontre respostas rápidas para pesquisar produtos, contactar fornecedores, publicar anúncios e gerir a sua conta.
              </p>
            </div>
      ...
      <main className="mx-auto max-w-[1280px] px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
              ...
              <article id={topic.id} key={topic.id} className="scroll-mt-36 rounded-lg border border-[#d6e8ed] bg-white p-5 shadow-[0_12px_28px_rgba(7,52,79,0.06)] sm:p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-xl font-extrabold text-[#082f4f]">{topic.title}</h3>
                    <p className="mt-1 text-sm leading-6 text-[#657d8d]">{topic.description}</p>
                  </div>
                </div>
        ...
        <section className="mt-14 border-t border-[#d6e8ed] pt-10" aria-labelledby="faq-title">
          <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr]">
            <div>
              <p className="market-kicker">Dúvidas comuns</p>
              ...
              <p className="mt-3 max-w-md text-sm leading-6 text-[#657d8d]">
                Respostas diretas para as situações mais comuns no Mercado STP.
              </p>
            </div>
            ...
            <div className="divide-y divide-[#dceaf0] border-y border-[#dceaf0]">
              {frequentlyAskedQuestions.map((item) => (
                <details key={item.question} className="group">
                  ...
                  <p className="max-w-2xl pb-5 pr-12 text-sm leading-7 text-[#516f82]">{item.answer}</p>
                </details>
              ))}
            </div>
          </div>
        ...
        <section className="mt-14 flex flex-col justify-between gap-5 rounded-lg border border-[#b8dce4] bg-[#eaf7f9] p-6 sm:flex-row sm:items-center sm:p-8">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.14em] text-[#078b8d]">Ainda com dificuldades?</p>
            <h2 className="mt-2 text-2xl font-extrabold text-[#082f4f]">Volte à vitrine e tente novamente</h2>
            <p className="mt-2 text-sm leading-6 text-[#516f82]">Remova os filtros ativos ou atualize a página para solicitar novamente os dados da base online.</p>
          </div>
